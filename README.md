...
| Ollama auto-detection | `_default_provider()` checks for a running Ollama instance first — no API key needed for local use |
...
For bugs and feature requests: [open an issue](https://github.com/Shrivastava-Aditya/bool-LLM-ngn/issues).
